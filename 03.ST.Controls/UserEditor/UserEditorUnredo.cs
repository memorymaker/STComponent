...
namespace ST.Controls
{
    public partial class UserEditor
    {
        private class UnredoClass
        {
            ...
            public UnredoClass(UserEditor UserEditor)
            {
            ...
            public void BindUserEditor(UserEditor UserEditor)
            {
                this.Clear();
            ...
            {
                UserEditor UserEditor = (UserEditor)sender;
            ...
            private void PushDelete(UserEditor UserEditor)
            {
            ...
            private void PushBack(UserEditor UserEditor)
            {
                int sp = UserEditor.Selection.Start;
                if (sp > 0)
                {
            ...
            private void PushShiftTab(UserEditor UserEditor)
            {
            ...
            private void PushTab(UserEditor UserEditor)
            {
                int sp = UserEditor.Selection.Start;
                int len = UserEditor.TabSpaceCount;
                int lineCount = Math.Max(UserEditor.Data.GetFullLineCount(sp, UserEditor.Selection.Length), 1);
            ...
            private void PushAppend(UserEditor UserEditor)
            {
            ...
            private void Undo(UserEditor UserEditor, int GroupCalledCount = 0)
            {
                Console.WriteLine($"Undo {GroupCalledCount}");
            ...
            private void Redo(UserEditor UserEditor, int GroupCalledCount = 0)
            {

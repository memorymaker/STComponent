...
{
    public partial class GraphicEditor : GraphicControl
    {
        #region Option
        ...
        #region Load
        public GraphicEditor(DataModeler target) : base(target)
        {
            LoadScreen();
            LoadThis();
            LoadAutoComplete();
        ...
        private void SetDefault()
        {
            ...
            Timer = new System.Threading.Timer(TimerDraw, null, Selection.ShowingPeriod, Selection.ShowingPeriod);
        ...
        #region Callback
        public void TimerDraw(object obj)
        {
            try
            {
        ...
        public bool ContainsByLineStyles(int charIndex)
        {
            ...
            foreach(KeyValuePair<string, GraphicEditorLineStyleInfo> pair in LineStyles)
            {
        ...
        public override bool WndProc(Message m)
        {
            bool rsCallBaseWndProc = false;
        ...
        private bool IsKeyBlockedByRangeStyles(int index, int startValueRevision = 0, int endValueRevision = 0)
        {
            ...
            foreach (KeyValuePair<string, GraphicEditorRangeStyle> pair in RangeStyles)
            {

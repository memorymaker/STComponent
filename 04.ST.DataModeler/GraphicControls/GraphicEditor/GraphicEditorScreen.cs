...
namespace ST.DataModeler
{
    ...
    {
        #region VScroll
        public GraphicScrollBar VScroll;
        private readonly int DefaultVScrollWidth = 17;
        private int VScrollValue = 0;
        private int VScrollMaxValue = 0;
        #endregion

        #region HScroll
        private GraphicScrollBar HScroll;
        private readonly int DefaultHScrollHeight = 17;
        ...
        {
            VScroll = new GraphicScrollBar(Target);
            ...
            HScroll = new GraphicScrollBar(Target);

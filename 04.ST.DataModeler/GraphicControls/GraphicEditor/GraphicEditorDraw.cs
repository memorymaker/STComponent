...
namespace ST.DataModeler
{
    public partial class GraphicEditor
    {
        public class DarwClass
        {
            ...
            public DarwClass(GraphicEditor _GraphicEditor)
            {
                // Temporary Size
                FontPixelSize = new Size(10, 10);
                this.Parent = _GraphicEditor;
            }
            ...
            private void DrawContent(Graphics g, bool drawCursor = false)
            {
                ...
                GraphicEditorStyleInfo commentStyleInfo = DrawContent_GetCommentStyleInfo(out usingSingleLineComment, out usingMultiLineComment);
                for (int i = 0; i <= maxVisabledLineIndex; i++)
                {
                    ...
                    // Draw Line Background #1(End) - Use GraphicEditor.LineStyles, GraphicEditor.Styles
            ...
            private GraphicEditorStyleInfo DrawContent_GetCommentStyleInfo(out bool usingSingleLineComment, out bool usingMultiLineComment)
            {
                usingSingleLineComment = false;
                usingMultiLineComment = false;

                GraphicEditorStyleInfo rs = null;
            ...
            private void DrawContentStringLine(IntPtr hdc, int i, int left, int top, int currentLineIndex, string text, int length, ref string fullText, GraphicEditorStyleInfo commentStyleInfo, bool usingMultiLineComment, bool usingSingleLineComment)
            {
                ...
                else
                {
                    ...
                    {
                        GraphicEditorRangeStyle info = pair.Value;
            ...
            private bool DrawContentStringLine_CheckCommentAbovePage(int currentLineIndex, ref string fullText, GraphicEditorStyleInfo commentStyleInfo, bool usingSingleLineComment)
            {
            ...
            private List<Range> DrawContentStringLine_GetCommentRanges(ref string text, ref bool hasCommentAboveLine, GraphicEditorStyleInfo commentStyleInfo, bool usingMultiLineComment, bool usingSingleLineComment)
            {

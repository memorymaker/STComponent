...
namespace ST.DataModeler
{
    ...
    {
        private UserRectangle VerticalDecrementButtonLayout = new UserRectangle(-1, 20,  0,  0, -1,  0); // Height To Width(Code)
        private UserRectangle VerticalEncrementButtonLayout = new UserRectangle(-1, 20, -1,  0,  0,  0); // Height To Width(Code)
        ...
        {
            Resize += GraphicScrollBar_Resize;
        }

        private void GraphicScrollBar_Resize(object sender, EventArgs e)
        {
            SetButtonsRectangle();
        }

...
namespace ST.DataModeler
{
    public partial class GraphicScrollBar
    {
        ...
        private void LoadInput()
        {
            ...
            // Events
            MouseDown += GraphicScrollBar_MouseDown;
            MouseMove += GraphicScrollBar_MouseMove;
            MouseUp += GraphicScrollBar_MouseUp;
            MouseLeave += GraphicScrollBar_MouseLeave;
            MouseWheel += GraphicScrollBar_MouseWheel;
        }
        ...
        private void GraphicScrollBar_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void GraphicScrollBar_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
        {
        ...
        private void GraphicScrollBar_MouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            Timer.Enabled = false;
        ...
        private void GraphicScrollBar_MouseLeave(object sender, EventArgs e)
        {
            ActionType = MouseActionType.None;
            Refresh();
        }

        private void GraphicScrollBar_MouseWheel(object sender, MouseEventArgs e)
        {
            if (UseWheel)
            {
